<template>
  <div class="finance-dashboard">
    ...
    <section class="modules-grid">
      ...
      <RouterLink class="module-tile" to="/products">
        <div class="icon-wrap product"><svg viewBox="0 0 24 24" width="24" height="24"><path d="M4 4h16v5H4V4Zm0 7h7v9H4v-9Zm9 0h7v9h-7v-9Zm-7-5v1h12V6H6Zm0 7v5h3v-5H6Zm9 0v5h3v-5h-3Z" fill="currentColor"/></svg></div>
        <div class="content">
          <strong>Products</strong>
          <span>Review product revenue, expenses, invoices, and customers.</span>
        </div>
      </RouterLink>
